# Project 1 - *MovieMoose*

**MovieMoose** shows the latest movies currently playing in theaters. The app utilizes the Movie Database API to display images and basic information about these movies to the user.
...
![](http://i.imgur.com/AZxX62b.gif)

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

Sorry, I had no time this week :(
